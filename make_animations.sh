...
ffmpeg -f image2 -framerate 4 -pattern_type glob -i  'frames/world_1280/*png' -i palette.png -lavfi paletteuse -pix_fmt yuv420p -c:v libx264  world.mp4
ffmpeg -f image2 -framerate 4 -pattern_type glob -i  'frames/world_1280/*png' -i palette.png -lavfi paletteuse -pix_fmt bgr8 world.gif
